...
def load_or_create_config():
    ...
    print("=== SMRITI Retail OS - Printer Selection ===")
            ...
            for file_path in prn_files:
                ...
                if success:
                    ...
                    try:
                        ...
                        print(f"Archived file to: {os.path.basename(dest_path)}")
                    except Exception as e:
                        print(f"Error archiving file: {e}")
                else:
                    # If print failed, rename slightly or wait so we don't loop endlessly
                    time.sleep(2)
