...
## 1. Purpose
Implementation of Vendor Mapping for SMRITI Retail OS.
...
- The linkage applies to the **template item** (style/article), not individual si—e variants.
...
| Column Key     | Label             | Aliases (fu——y match)         |
|----------------|-------------------|-------------------------------|
...
| [smriti_item_master.js](../../apps/smriti_retail_os/smriti_retail_os/public/js/item.js) | `VENDOR CODE` column + `EXTRA_ALIASES` for fu——y matching |
