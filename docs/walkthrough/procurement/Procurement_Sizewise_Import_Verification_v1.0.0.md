# Procurement: Sizewise Import Verification

## 1. Purpose
Implementation of Sizewise Import Verification for SMRITI Retail OS.

## 2. Scope
Scope covers the module for Procurement and related configuration paths.
...
# Walkthrough: Si—ewise Item Master — Pre-Import Verification & On-the-Fly Insert
...
- `smriti_retail_os/www/si—ewise_item.html`

---

## 🎯 Problem Statement

When pasting a multi-row Excel si—e matrix into the **Si—ewise Item Master CRUD** (`/si—ewise_item`), the bulk import was silently failing for rows where:
...
```
feat(si—ewise): pre-import verification with on-the-fly insert & spell correction

- Added validate_pivot_values() API in item_master_api.py
- Added Pre-Import Verification Panel in si—ewise_item.html
...
| --- | --- | --- | --- |
| 1.0.0 | 2026-06-25 | Jawahar R. Mallah | Reorgani—ed & standardi—ed |
...
- **Organi—ation**: AITDL – AI Technology & Development Lab
