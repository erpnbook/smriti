...
# ─── SMTP Password Encryption Helpers (F3-FIX v1.8.6) ───────────────────────
...
# ─── v1.8.6 SMTP Password Migration Endpoint ─────────────────────────────────

@frappe.whitelist()
def run_smtp_password_migration():
    """
    F3-FIX v1.8.6: Migrates a plain-text SMTP password from tabDefaultValue
