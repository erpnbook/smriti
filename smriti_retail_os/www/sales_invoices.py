# -*- coding: utf-8 -*-
#
# @file: smriti_retail_os/www/sales_invoices.py
# @description: Python controller for the standalone SMRITI Sales Invoices page.
...
no_cache = 1
title = "SMRITI Billing Transactions"

def get_context(context):
    """
    Called by Frappe before rendering www/sales_invoices.html.
    ...
    if not any(r in roles for r in allowed_roles):
        frappe.throw(
            "Access Denied: Billing Transactions tracker is restricted to Cashiers, Store Managers, and System Managers.",
