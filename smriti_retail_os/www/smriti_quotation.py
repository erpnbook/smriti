# -*- coding: utf-8 -*-
#
# @file: smriti_retail_os/www/smriti_quotation.py
# @description: Python controller for the standalone SMRITI Quotation Manager page.
...
no_cache = 1
title = "SMRITI Quotation Manager"

def get_context(context):
    """
    Called by Frappe before rendering www/smriti-quotation.html.
    ...
    try:
        check_page_access("smriti_quotation")
