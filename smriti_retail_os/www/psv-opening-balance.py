# -*- coding: utf-8 -*-
#
# @file: smriti_retail_os/www/psv-opening-balance.py
# @description: Python controller for the standalone SMRITI PSV Opening Balances page.
...
#
# NOTE: This file MUST be named psv-opening-balance.py (hyphenated) to match
#       www/psv-opening-balance.html. Frappe resolves .py by exact filename.
#       The underscore variant psv_opening_balance.py is kept as a legacy stub.
#

import frappe

no_cache = 1
title = "SMRITI Opening Balances"

def get_context(context):
    """
    Called by Frappe before rendering www/psv-opening-balance.html.
    ...
    if not any(r in roles for r in allowed_roles):
        frappe.throw(
            "Access Denied: Opening Balances management is restricted to Store Managers and System Managers.",
