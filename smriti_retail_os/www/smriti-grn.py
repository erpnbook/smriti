# -*- coding: utf-8 -*-
#
# @file:    smriti_retail_os/www/smriti-grn.py
# @desc:    Page controller for SMRITI GRN (Goods Receipt Note) dedicated form.
...
no_cache = 1
title    = "SMRITI — GRN / Goods Receipt"


def get_context(context):
    """
    Page controller for the dedicated GRN creation form.
    Only SMRITI Store Managers and System Managers may create GRNs.
    """
    # ── Guest redirect ────────────────────────────────────────────────────────
    ...
    # ── Role guard: GRN creation is manager-only ──────────────────────────────
