# -*- coding: utf-8 -*-
#
# @file: smriti_retail_os/www/payments.py
# @description: Page controller for SMRITI Payments / Receipts (Payment Entry) ledger portal.
...
no_cache = 1
title = "SMRITI Payment Ledger"

def get_context(context):
    """
    Called by Frappe before rendering www/payments.html.
    ...
    if not any(r in roles for r in allowed_roles):
        frappe.throw(
            "Access Denied: Payment module is restricted to Cashiers, Store Managers, and System Managers.",
