# -*- coding: utf-8 -*-
#
# @file: smriti_retail_os/www/sales_return.py
# @description: Python controller for the standalone SMRITI Sales Returns page.
...
def get_context(context):
    """
    Called by Frappe before rendering www/sales_return.html.
    ...
    if not any(r in roles for r in allowed_roles):
        frappe.throw(
            "Access Denied: Sales Returns portal is restricted to Cashiers, Store Managers, and System Managers.",
