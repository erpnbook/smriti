# -*- coding: utf-8 -*-
#
# @file: smriti_retail_os/www/eway_bill.py
# @description: Page controller for SMRITI E-way Bill Management portal.
...
#
# @file: smriti_retail_os/www/eway_bill.py
# @description: Python controller for the standalone SMRITI E-way Bill page.
...
no_cache = 1
title = "SMRITI E-way Bills"

def get_context(context):
    """
    Called by Frappe before rendering www/eway_bill.html.
    ...
    if not any(r in roles for r in allowed_roles):
        frappe.throw(
            "Access Denied: E-way Bills module is restricted to Cashiers, Store Managers, and System Managers.",
