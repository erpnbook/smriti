# -*- coding: utf-8 -*-
#
# @file: smriti_retail_os/www/suppliers.py
# @description: Python controller for the standalone SMRITI Suppliers page.
...
def get_context(context):
    """
    Called by Frappe before rendering www/suppliers.html.
    ...
    if not any(r in roles for r in allowed_roles):
        frappe.throw(
            "Access Denied: Supplier Registry is restricted to Store Managers and System Managers.",
