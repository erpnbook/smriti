# -*- coding: utf-8 -*-
#
# @file: smriti_retail_os/www/customers.py
# @description: Python controller for the standalone SMRITI Customers page.
...
def get_context(context):
    """
    Called by Frappe before rendering www/customers.html.
    ...
    if not any(r in roles for r in allowed_roles):
        frappe.throw(
            "Access Denied: Customer Directory is restricted to Cashiers, Store Managers, and System Managers.",
